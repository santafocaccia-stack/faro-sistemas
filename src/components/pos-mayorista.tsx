...
export function PosMayorista({ productos, clientes }: Props) {
  ...
  function agregarAlCarrito(producto: Producto) {
    setCart((prev) => {
      ...
      return [...prev, { producto, cantidad: 1, precioUnitario: Number(producto.precioMayorista) }];
    });
  }
    ...
    <div className="flex h-[calc(100vh-0px)] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col border-r overflow-hidden">
        <div className="p-4 border-b">
          <h1 className="text-lg font-bold mb-3">Venta Mayorista</h1>
      ...
      <div className="w-96 flex flex-col bg-background">
        ...
        <div className="border-t p-4 space-y-4">
          ...
          {/* Cliente — obligatorio en mayorista */}
          ...
          <Button
            ...
            disabled={isPending || cart.length === 0 || !clienteId}
          >
            {confirmado ? (
