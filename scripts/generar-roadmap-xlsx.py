...
TAREAS = [
    ...
    ("Versiones / Verticales", "Gesto Balanza funcional: integración con balanza digital + venta por peso", "Alta", "Hecho", "POS con venta por peso: modal de gramos (atajos 250/500/1000 g + subtotal en vivo), edición de peso en carrito, y lectura de etiquetas de balanza con peso embebido (EAN-13 prefijo 2 -> PLU + peso). Página /dashboard/balanza con guía de 3 pasos. Plan habilitado (proximamente:false) y nav activo. Pendiente futuro: configurar el formato exacto de etiqueta por marca de balanza"),
