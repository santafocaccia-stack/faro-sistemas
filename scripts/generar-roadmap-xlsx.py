...
TAREAS = [
    ...
    ("Versiones / Verticales", "Gesto Balanza funcional: integración con balanza digital + venta por peso", "Alta", "Hecho", "Plan habilitado + nav + página guía /dashboard/balanza. Lectura de etiquetas de balanza con peso embebido (EAN-13 prefijo 2 -> PLU + peso) PORTADA al POS real (pos-container; el primer intento quedó en un componente muerto ya borrado). Peso a mano: por ahora vía 'línea suelta'. Pendiente futuro: modal de peso al tocar un producto por_kg, y configurar el formato exacto de etiqueta por marca de balanza"),
