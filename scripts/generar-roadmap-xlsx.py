...
TAREAS = [
    ...
    ("Versiones / Verticales", "Gesto Atmosféricos: historial, agenda y pedidos para días futuros + arreglar ruta en Maps", "Alta", "En progreso", "Historial ya existía; AGENDA (navegación entre días) + pedidos para días futuros HECHO. FALTA: arreglar la ruta en Maps (geocoding de direcciones de texto falla; evaluar guardar ubicación exacta / link de Maps por pedido sin pagar Google API)"),
